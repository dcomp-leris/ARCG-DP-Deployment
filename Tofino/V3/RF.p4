...
control SwitchIngress(
    ...
    // Alireza Begin (The name of register)
        RegisterAction<bit<32>, bit<8>, bit<32>>(ingress_host_ifg_reg) store_ingress_host_ifg_reg = {
            //void apply(inout bit<32> value, out bit<32> result) { result is output
    ...
    if (ig_intr_md.ingress_port == MIRROR_PORT){
        ...
        if (hdr.mirror.host_ifg!=0){
            ...
            store_ingress_host_ifg_reg.execute(ig_md.metadata_flowID);
        }
        // Alireza added
