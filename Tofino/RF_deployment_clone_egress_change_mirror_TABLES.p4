...
control SwitchIngress(
    ...
    //     //hdr.mirror.egress_port = ig_tm_md.ucast_egress_port;
    //     hdr.mirror.egress_port = 136;
    //     hdr.mirror.header_info = 1;
    //     hdr.mirror.mirror_session = 1;
    //     ig_intr_dprsr_md.mirror_type = HEADER_TYPE_MIRROR_INGRESS;
    //     hdr.mirror.packet_size = lpf_output_packet_size;
    //     hdr.mirror.frame_size = ig_md.metadata_frame_size + hdr.udp.length_;
    //     //hdr.mirror.flowid = ig_md.metadata_flowID;
    //     hdr.mirror.flowid = 5;
    //     //hdr.mirror.egress_global_tstamp = (bit<48>)ig_intr_prsr_md.global_tstamp;
    // }
    ...
    RegisterAction<bit<8>, bit<8>, bit<8>>(marking_register)  store_marking_register = {
            void apply(inout bit<8> value) {
                value = ig_md.metadata_majority;
            }

    };

    // action action_majority(bit<8> new_majority){
    ...
    // action classify_tree(bit<8>classify_result){
    ...
    //     }
    //     else if(classify_result == 3){
    //         contador3 = contador3 + 1;
    //     }
    // }

    action classify_result1(bit<8>classify_result){
        //classify_result = 1
        contador1 = contador1+1;
    }
    action classify_result2(bit<8>classify_result){
        //classify_result = 2
        contador2 = contador2 +1;
    }

    table table_frame_size_tree1{
        key = {
    ...
    table table_packet_size_tree2{
        key = {
            ig_md.metadata_packet_size: range;
        }
        actions = {
            classify_result1();
            classify_result2();
    ...
    table table_ipg_tree3{
        key = {
            ig_md.metadata_ipg_16msb: range;
        }
        actions = {
            classify_result1();
            classify_result2();
    ...
    // action set_majority(bit<8>classify_result){
    //     if(classify_result)
    // }

    table table_ifg_tree4{
        key = {
            ig_md.metadata_ifg_16msb: range;
        }
        actions = {
            classify_result1();
            classify_result2();
    ...
    action set_majority(bit<8>majority){
        ig_md.metadata_majority = majority;
    }

    table table_check_majority{
        key = {
            contador1: range;
        }
        actions = {
    ...
    if (ig_intr_md.ingress_port == MIRROR_PORT){
        ...
        ig_md.metadata_input_ipg = lpf_output_ipg;
        ...
        //         return "CG"
        //     if IPI <= 8464.0:
        //         if FS <= 140.5 and IPI <= 545.0 and IPI > 11.0:
        //             return "Other"
        //         return "CG"
        //     return "Other"
        // elif IFI <= 7578762.0:
        //     return "AR" if IFI <= 7554585.5 else "Other"
        // else:
        //     return "AR" if FS > 601.5 else "Other"
        ...
        // bit<8> contador2;
        // bit<8> contador3;
        // if (ig_md.metadata_ifg <= 6612029) {
        //     if (ig_md.metadata_frame_size > 772) {
        //         result_tree1 = 2; // cg
        //         contador2 = contador2 +1;
        //     }
        //     if (ig_md.metadata_ipg <= 8464) {
        //         if (ig_md.metadata_frame_size <= 140 && ig_md.metadata_ipg <= 545 && ig_md.metadata_ipg > 11) {
        //             result_tree1 = 3; // other
        //             contador3 = contador3 +1;
        //         } else {
        //             result_tree1 = 2; // cg
        //             contador2 = contador2 + 1;
        ...
        //         contador3 = contador3 + 1;
        //     }
        // } else if (ig_md.metadata_ifg <= 7578762) {
        //     if (ig_md.metadata_ifg <= 7554585) {
        //         result_tree1 = 1; // ar
        //         contador1 = contador1 +1;
        //     } else {
        //         result_tree1 = 3; // other
        ...
        //     }
        // } else {
        //     if (ig_md.metadata_frame_size > 601) {
        //         result_tree1 = 1; // ar
        //         contador1 = contador1 +1;
        //     } else {
        //         result_tree1 = 3; // other
        ...
        // if (ig_md.metadata_ipg <= 70271) {
        //     if (ig_md.metadata_frame_size <= 113) {
        //         result_tree2 = 3; // Other
        //     } else if (ig_md.metadata_ipg > 7941) {
        //         if (ig_md.metadata_ifg > 6398925) {
        //             result_tree2 = 1; // AR
        //             contador1 = contador1 + 1;
        //         } else {
        //             result_tree2 = 2; // CG
        ...
        //         contador2 = contador2 +1;
        //     }
        // } else if (ig_md.metadata_ipg <= 893722) {
        //     if (ig_md.metadata_ipg > 203147) {
        //         result_tree2 = 1; // AR
        //         contador1 = contador1 + 1;
        //     } else if (ig_md.metadata_ifg <= 4451710) {
        //         result_tree2 = 3; // Other
        //         contador3 = contador3 + 1;
        //     } else {
        //         result_tree2 = 1; // AR
        ...
        // //tree3 
        // bit<8> result_tree3;
        // if(ig_md.metadata_ifg <= 6357515){
        //     if(ig_md.metadata_frame_size <= 114){
        //         result_tree3 = 3;
        //         contador3 = contador3 + 1;
        //     }
        //     else if(ig_md.metadata_ifg > 9686){
        //         if(ig_md.metadata_frame_size > 860){
        //             result_tree3 = 2;
        //             contador2 = contador2 +1;
        //         }
        //         else{
        ...
        //     }
        // }
        // else if(ig_md.metadata_ifg <= 28572585){
        //     result_tree3 = 1;
        //     contador1 = contador1 + 1;
        // }
        // else{
        ...
        // bit<8> result_tree4;
        // if(ig_md.metadata_ipg <= 67892){
        //     if(ig_md.metadata_frame_size <= 112){
        //         result_tree4 = 3;
        //         contador3 = contador3 +1;
        //     }
        //     if(ig_md.metadata_ifg > 6241376){
        //         result_tree4 = 1;
        //         contador1 = contador1 + 1;
        //     }
        //     else{
        ...
        //     }
        // }
        // else if(ig_md.metadata_frame_size > 780){
        //     result_tree4 = 1;
        // }
        // else{
        //     result_tree4 = 3;
        ...
        // bit<8> result_tree5;
        // if(ig_md.metadata_frame_size <= 109){
        //     result_tree5 = 3;
        //     contador3 = contador3 + 1;
        // }
        // if(ig_md.metadata_ipg <= 8228){
        //     if(ig_md.metadata_ifg <= 5801867){
        //         result_tree5 = 2;
        //         contador2 = contador2 + 1;
        //     }
        //     else{
        ...
        //     }
        // }
        // else if(ig_md.metadata_frame_size > 1162){
        //     if(ig_md.metadata_frame_size < 4554875){
        //         result_tree5 = 2;
        //         contador2 = contador2 + 1;
        //     }
        //     else{
        ...
        //     }
        // }
        // else if(ig_md.metadata_ifg > 14212795){
        //     if(ig_md.metadata_ifg > 20457180){
        //         result_tree5 = 3;
        //         contador3 = contador3 + 1;
        //     }
        //     else{
        ...
        //         ig_md.metadata_majority = contador1;
        //     } else {
        //         ig_md.metadata_majority = contador3;
        //     }
        // } else {
        //     if (contador2 >= contador3) {
        //         ig_md.metadata_majority = contador2;
        //     } else {
        //         ig_md.metadata_majority = contador3;
        //     }
        // }
        ...
        //else {
        bit<16> frame_size_temp = ig_md.metadata_frame_size;
        bit<16> packet_size_temp = ig_md.metadata_packet_size;
        bit<32> ipg_temp = ig_md.metadata_ipg;
        bit<32> ifg_temp = ig_md.metadata_ifg;
        if(hdr.mirror.has_rtp == 0){ //USE FRAME SIZE OR IFG HERE MAY AFFECT WHICH YOU USE AFTER
            ig_md.metadata_majority = 3;
        }
        else{

        
            table_frame_size_tree1.apply();
            table_packet_size_tree2.apply();
            ...
            ig_md.metadata_ipg_16msb = ig_md.metadata_ipg[31:16];
            ig_md.metadata_ifg_16msb = ig_md.metadata_ifg[31:16];
            table_ipg_tree3.apply();
            table_ifg_tree4.apply();

            //MAJORITY
            // if(contador1 > contador2){
            //     ig_md.metadata_majority = 1;
            // }
            // else{
            //     ig_md.metadata_majority = 2;
            // }

            table_check_majority.apply();
            // if(contador1 == 4 || contador1 == 3){
            //     ig_md.metadata_majority = 1;
            // }

            // if(contador2 == 2 || contador2 == 3 || contador2 == 4){
            //     ig_md.metadata_majority = 2;
            // }
